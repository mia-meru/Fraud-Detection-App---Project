...
if st.button("Predict"):
    ...
    st.subheader("Fraud Prediction Probabilities")
    st.write(f"Non-Fraud: {probs[0]*100:.4f}%")
    st.write(f"Fraud: {probs[1]*100:.4f}%")

    st.progress(float(probs[1]))  # Fraud probability bar